...
@include('public.header')
    ...
    @include('public.notification_message')
        ...
        <section id="page-content" class="page-wrapper">
           ...
           @include('public.category_block_display')
           @include('public.featured_gifts')
           @include('public.gift_promotion_blocks')
           @include('public.giftlist_multi_tab')
           @include('public.blog_section')
           @include('public.newsletter_subscription')
