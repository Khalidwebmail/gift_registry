...
<header class="header-area header-wrapper <?php if($pageInfo[0] == 'Home'){echo 'header-2';}?>">
<!-- header-top-bar -->
           ...
           <button class="search-toggle">
            ...
            <form action="{{URL::to('gift-search-results')}}" method="post">
                ...
                <div class="top-search-box">
                    <input type="text" name="gift_title" placeholder="Search here your product...">
                    <button type="submit">
                        <i class="zmdi zmdi-search"></i>
                    </button>
                </div>
