<?php
$pageInfo = ['pageTitle' => 'Manage Users',
    'pageSummery' => 'Manage Users/Customers',
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @else
                                            <li><a href="#" data-toggle="modal" data-target="#modal_disable{{$key+1}}"> <i
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('/manage_users_edit')}}/{{$val->id}}/update"
                                                      method="post">
                                                    {{ csrf_field() }}
                                ...
                                <div class="modal fade" id="modal_delete{{$key+1}}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('/manage_users_delete')}}/{{$val->id}}/delete"
                                                      method="post">
                                                    {{ csrf_field() }}
                                ...
                                <div class="modal fade" id="modal_enable{{$key+1}}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('/manage_users_enable')}}/{{$val->id}}/enable"
                                                      method="post">
                                                    {{ csrf_field() }}
                                ...
                                <div class="modal fade" id="modal_disable{{$key+1}}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('/manage_users_disable')}}/{{$val->id}}/disable"
                                                      method="post">
                                                    {{ csrf_field() }}
