        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="vendor_image/{{Session::get('user.image')}}" class="img-circle user-image">
              <span class="hidden-xs">{{Session::get('user.user_email')}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
